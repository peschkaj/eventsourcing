...
// Version is the event version used in event.Version and aggregateRoot
type Version uint64
...
func (ar *AggregateRoot) setInternals(id uuid.UUID, version Version) {
	ar.aggregateID = id
...
// update sets the AggregateVersion to the values in the last event
